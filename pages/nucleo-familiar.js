       ...
       <div className="rounded-xl border p-2 w-full">
        <h2 className="font-bold text-sm text-cor_principal-700 mb-3">Recebe algum beneficio?</h2>
          <div className="flex gap-[8px] justify-center">
           ...
           <InputText fatherClassName="flex-auto" withLabel={true} name="benefícios_valor_total"  label="Benefícios recebidos valor total" className="rounded-xl"/>
          ...
          <div className="rounded-xl borde ">
           <h2 className="font-bold text-sm text-cor_principal-700 mb-1">É o beneficiario?</h2>
             <div className="flex gap-[3px] justify-center">
                <Checkbox label="Não" value="Não" name="recebe_algum_beneficio[]"/>
                <Checkbox label="Sim" value="Sim" name="recebe_algum_beneficio[]"/>
    ...
    <FormDefault API="users/create" id="formCad" resetAfterSend={true} className="max-w-[1000px] w-full flex flex-wrap gap-2 mx-auto justify-center items-stretch">
      <h1 className="text-black text-2xl font-medium font-mono py-4   w-full text-center mb-3 ">Dados Do cadastro</h1>
          <SelectInput  fatherClassName="flex-3" withLabel={true} name="forma_de_acesso" label="Forma de Acesso" className="rounded-xl">
           ...
           <InputText fatherClassName="flex-1" withLabel={true} name="ponto_de_coleta" label="Ponto de coleta(beneficios)" className="rounded-xl"/>
           <InputText fatherClassName="flex-1" withLabel={true} name="data" label="data " className="rounded-xl"/>
           <SelectInput fatherClassName="flex-1" withLabel={true} name="local_onde_foi_feito_o_cadastro"  label="Local onde foi feito o cadastro" className="rounded-xl">
           <option value="">Selecione Uma Opção</option>
           {
