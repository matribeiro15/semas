      ...
      <div className="flex-auto flex flex-col items-center justify-center p-3">
          ...
          <h1 className="text-black text-2xl font-medium font-mono  InputText-cursive  justify-center  py-3 ">Documentação do Responsável</h1>
           <AlternativeForm action="/api/users/create" id="formCad" resetAfterSend={true} className="max-w-[800px] w-full flex flex-wrap gap-2 mx-auto justify-center items-stretch">
                <InputText fatherClassName="flex-auto" withLabel={true} name="nome" label="Nome" className="rounded-xl" required/>
                ...
                <InputText fatherClassName="flex-auto" withLabel={true} name="indentificacao_estrangeira" label="Indentificação estrangeira" className=" rounded-xl"/>
          ...
          <h1 className="text-black text-2xl font-medium font-mono  text-condensed w-full text-center  py-3">Dados Pessoais</h1>
                 <SelectInput fatherClassName="flex-auto" withLabel={true} name="estado_civil" label="Estado civil" className="rounded-xl" required>
                ...
                <InputText fatherClassName="flex-auto" withLabel={true} name="data_nasc" mask="dd/dd/dddd" label="Data de nascimento" className="rounded-xl " required/>
                 <SelectInput fatherClassName="flex-auto" withLabel={true} name="escolaridade" label="Escolaridade" className="rounded-xl " required>
                    <option value="">Selecione Uma Opção</option>
                 ...
                 <SelectInput fatherClassName="flex-auto" withLabel={true} name="sexo" label="Sexo" className="rounded-xl" required>
                    <option value="">Selecione Uma Opção</option>
                ...
                <InputText fatherClassName="flex-auto" withLabel={true} name="renda:individual" mask="R$dddd,dd"label="Renda Individual" className="rounded-xl" required/>
            <h1 className="text-black text-2xl font-medium font-mono  w-full text-center  py-3 ">Endereço</h1>
                ...
                <SelectInput fatherClassName="flex-auto" withLabel={true} name="bairro" label="Bairro/Setor" className="rounded-xl" required>
                  <option value="">Selecione Uma Opção</option>
                  {
                    bairros.map((el,id)=>{
                ...
                <InputText fatherClassName="flex-auto" withLabel={true} name="número"  mask="ddddd" label="Número" className="rounded-xl"/>
                 <SelectInput fatherClassName="flex-auto" withLabel={true} name="area" mb-1 label="Área"  className="rounded-xl mb-1 " required>
                    <option value="">Selecione Uma Opção</option>
             ...
             <h1 className="text-black text-2xl font-medium font-mono  w-full text-center  py-3">Tipo de Habitação</h1>
                 <SelectInput fatherClassName="flex-auto" withLabel={true} name="tipo_de_imovel" label="Tipo de Imóvel" className="rounded-xl" required>
                    <option value="">Selecione Uma Opção</option>
                ...
                <InputText  fatherClassName="flex-2" withLabel={true} name="tempo_de_moradia"   label="Tempo de moradia" className="rounded-xl"/>
                  <SelectInput fatherClassName="flex-auto" withLabel={true} name="edificada_em_madeira" label="Edificada em:" className="rounded-xl" required>
                    <option value="">Selecione Uma Opção</option>
                    <option value="Madeira">Madeira</option>
                    <option value="Alvenaria">Alvenaria</option>
                    <option value="Mista">Mista</option>
                  </SelectInput>
                  <SelectInput fatherClassName="flex-auto" withLabel={true} name="estado_de_conservacao" label="Estado de Conservação" className="rounded-xl " required>
                    <option value="">Selecione Uma Opção</option>
