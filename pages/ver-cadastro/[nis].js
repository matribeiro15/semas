...
export default function VerCadastro(){
  ...
  const Nucleo = function(props){
    return (
      <div className="flex-auto w-full flex mx-auto items-stretch rounded max-w-[900px] col-3 edit flex-auto w-full flex col-3 edit p-1  mx-auto items-stretch transition hover:scale-110 rounded-md hover:shadow-lg hover:border hover:bg-neutral-100">
  ...
  const Cell = function(props){
    return (
      <div className={"text-lg text-black  flex-auto flex flex-col p-1 mb-1 from-cor_principal-800 fontMaster "+props.className}>
...
<PageDefault title="Ver cadastro | SEMAS" checkUserLogin={true} loading={!client} callbackUser={getUser} label="Cadastro de triagem Social" className="max-w-[900px]">
  <div className="w-100 bg-white shadow py-2 px-5 header-new position-relative protege rounded-xl shadow-cor_principal-600/50 max-w-[900px]">
    <h1 className="text-cor_principal-900 text-2xl font-medium font-mono py-2  w-full text-center">Indentificação</h1>
      ...
      <div className="max-w-[900px] flex-auto w-full   p-1 gap-auto mx-auto items-stretch transition hover:scale-110 rounded-md hover:shadow-lg hover:border hover:bg-neutral-100">
    ...
    <div className="flex-auto  flex-col items-center justify-center  p-3 ">
      <h1 className="text-cor_principal-900 text-2xl font-medium font-mono py-2 w-full text-center">Endereço</h1>
        <div className="max-w-[900px] flex-auto w-full flex  p-1 gap-auto mx-auto items-stretch transition hover:scale-110 rounded-md hover:shadow-lg hover:border hover:bg-neutral-100">
    ...
    <div className="flex-auto flex flex-col items-center justify-center  p-3 ">
      <h1 className=" text-cor_principal-900 text-2xl font-medium font-mono py-2 w-full text-center">Tipo de Habitação</h1>
        <div className="max-w-[900px] flex-auto  w-full flex  p-1 gap-auto mx-auto items-stretch transition hover:scale-110 rounded-md hover:shadow-lg hover:border  hover:bg-neutral-100">
    ...
    <h1 className="text-cor_principal-900 text-2xl font-medium font-mono py-2 w-full text-center" >Composição Familiar</h1>
      {
    ...
    <h1 className="text-cor_principal-900 text-2xl font-medium font-mono py-2 w-full text-center">Renda</h1>
      <div className="max-w-[300px] flex-auto  w-full flex  p-1 gap-auto mx-auto items-stretch transition hover:scale-110 rounded-md hover:shadow-lg hover:border   hover:bg-neutral-100 ">
      ...
      <h1 className="text-cor_principal-900 text-2xl font-medium font-mono py-2 w-full text-center">Outros dados</h1>
        <div className="max-w-[900px] flex-auto w-full flex  p-1 gap-auto mx-auto items-stretch transition hover:scale-110 rounded-md hover:shadow-lg hover:border hover:bg-neutral-100">
